...
public static class ExpressionsExtensions
{
    ...
    public static Expression<Func<TEntity, bool>> BuildContainsExpression<TEntity>(
        this Expression<Func<TEntity, string>> keySelector, IEnumerable<TEntity> entities) where TEntity : class
    {
    ...
    /// <typeparam name="TEntity">The type of the entity.</typeparam>
    /// <returns>The expression.</returns>
    public static Expression<Func<TEntity, bool>> BuildEqualsExpression<TEntity>(
        this Expression<Func<TEntity, string>> keySelector, TEntity entity)
    {
        ...
        var keySelectorLambda =
            Expression.Lambda<Func<TEntity, string>>(Expression.Property(parameter, keyName), parameter);
