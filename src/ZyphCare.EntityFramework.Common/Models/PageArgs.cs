namespace ZyphCare.EntityFramework.Common.Models;
...
public record PageArgs
{
    ...
    public static PageArgs FromPage(int? page, int? pageSize)
    {
        return new PageArgs { Offset = page * pageSize, Limit = pageSize };
    }
    ...
    public static PageArgs FromRange(int? offset, int? limit)
    {
        return new PageArgs { Offset = offset, Limit = limit };
    }
    ...
    public PageArgs Next()
    {
        return this with { Offset = Page + 1 };
    }
}